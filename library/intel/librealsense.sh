...
# Repository
realsense_dir="$HOME/Workspace/thirdparty/library"
...
# Installation
echo "cmake -S . -B build -D CMAKE_BUILD_TYPE=Release -D BUILD_EXAMPLES=ON -D BUILD_WITH_OPENMP=ON -D BUILD_EXAMPLES=ON -D BUILD_PYTHON_BINDINGS=ON -D BUILD_WITH_CUDA=ON"
