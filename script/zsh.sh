...
then
  ...
  wget -P $HOME https://raw.githubusercontent.com/taehun-kmu/auto/main/script/zsh/.zshrc
  wget -P $HOME https://raw.githubusercontent.com/taehun-kmu/auto/main/script/zsh/.p10k.zsh
